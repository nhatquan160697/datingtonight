<aside class="col-lg-4 agileits-w3ls-right-blog-con text-left">
	<div class="right-blog-info text-left">
		<div class="tech-btm">
			<img src="/templates/datingtonight/images/banner1.jpg" class="img-fluid" alt="">
		</div>
		<div class="tech-btm">
			<h4>Categories</h4>
			<ul class="list-group single">
				@foreach($getNameType as $getName)
				<li class="list-group-item d-flex justify-content-between align-items-center">
					<a href="#" title="">{{$getName->name_type}}</a>
					<span class="badge badge-primary badge-pill">{{$countHotel}}</span>
				</li>
				@endforeach
			</ul>
		</div>
