            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                <form role="form" action="{{ route('admin.admin.edit',$getItem->id_admin) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="password" name="txtPassword" value="{{ $getItem->password }}" />
                    </div>
                    <div class="form-group">
                        <label>Fullname</label>
                        <input class="form-control" name="txtFullname" value="{{ $getItem->fullname }}" />
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-default">Edit administrator</button>
